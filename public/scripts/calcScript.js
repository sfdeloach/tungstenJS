...
$(document).ready(function () {
    ...
    $('#body-ave').text(Math.round10(bodyAve / totalParticipants, -1).toFixed(1) + '%');
    $('#flex-ave').text(Math.round10(flexAve / totalParticipants, -1).toFixed(1) + '%');
    $('#sit-ave').text(Math.round10(sitAve / totalParticipants, -1).toFixed(1) + '%');
    $('#bench-ave').text(Math.round10(benchAve / totalParticipants, -1).toFixed(1) + '%');
    $('#leg-ave').text(Math.round10(legAve / totalParticipants, -1).toFixed(1) + '%');
    
    if (runPartiticipants === 0) {
        $('#run-ave').text('n/a');
    } else {
        $('#run-ave').text(Math.round10(runAve / runPartiticipants, -1).toFixed(1) + '%');
    }
    
    if (walkParticipants === 0) {
        $('#walk-ave').text('n/a');
    } else {
        $('#walk-ave').text(Math.round10(walkAve / walkParticipants, -1).toFixed(1) + '%');
    }
